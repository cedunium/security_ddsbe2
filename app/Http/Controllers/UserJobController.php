...
use App\Models\UserJob; // model is located inside Models Folder
...
Class UserJobController extends Controller{
    ...
    // Return the list of usersjob @return Illuminate\Http\Response
    public function index(){
        $usersjob = UserJob::all();
        return $this->successResponse($usersjob);
    }
    // Obtains and show one userjob @return Illuminate\Http\Response
